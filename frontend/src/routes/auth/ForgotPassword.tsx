            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-4 h-11 border border-gray-300 rounded-xl placeholder-gray-400 text-primary-text focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-base transition-all"
